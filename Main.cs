...
namespace MenuManagement {
 internal class Main {
  ...
  private void TestMenuBuilder(IPlayer client) {
   Menu menu = savedMenu;
  ...
  private void TestMenuManager(IPlayer client, Menu menu, MenuItem menuItem, int itemIndex, bool forced, dynamic data) {
